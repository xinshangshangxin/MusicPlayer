...
<body>
<div class="modal fade bs-example-modal-sm" id="showtext" tabindex="-1" role="dialog" aria-labelledby="mySmallModalLabel"
     aria-hidden="true">
            ...
            <div id="player">
                ...
                <div class="row">
                    ...
                    <div class="col-xs-5 col-md-3">
                        <div class="control">
                            <img id="previewsong" src="./images/rewind.png"
                                 class="img-responsive pull-left" alt="">

                            <div class="pull-left">&nbsp;&nbsp;</div>
                            <img id="playpaush" src="./images/play.png"
                                 class="img-responsive pull-left" alt="">

                            <div class="pull-left">&nbsp;&nbsp;</div>
                            <img id="nextsong" src="./images/fastforward.png"
                                 class="img-responsive pull-left" alt="">
                        </div>
                    </div>
